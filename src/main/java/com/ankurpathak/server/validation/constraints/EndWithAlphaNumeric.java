...
import com.ankurpathak.server.validation.constraints.validator.EndWithAlphaNumericValidator;
...
public @interface EndWithAlphaNumeric {
    ...
    String message() default "{com.ankurpathak.server.validation.constraints.EndWithAlphaNumeric.message}";
